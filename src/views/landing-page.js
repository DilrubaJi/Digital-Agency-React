  ...
  return (
    <div className="landing-page-container">
      <Helmet>
        ...
        <meta
          name="description"
          content="Software engineering company that has a broad set of skills that include, AI, GPT, ChatBot, IOS, Games, Web development, systems solutions"
        />
      ...
      <div className="landing-page-top-container">
        <nav data-role="Header" className="landing-page-navbar">
          <h1 className="landing-page-logo">Digital Agency</h1>
          <div className="landing-page-right-side">
            ...
            <a href="#main-section" className="landing-page-link">
              <SolidButton button="Explore Projects"></SolidButton>
            </a>
          </div>
        ...
        <div className="landing-page-hero">
          <div className="landing-page-content-container">
            ...
            <h2 className="landing-page-subheading">
              ...
              <br className="Subheading"></br>
              <span className="Subheading">AI-driven marketing solutions</span>
              <br></br>
            </h2>
            <span className="landing-page-text14">
              Take your business to the next level with innovative AI solutions
            </span>
            <SolidButton
              button="Explore homes"
      ...
      <div className="landing-page-footer">
        <div className="landing-page-menu">
          ...
          <div className="landing-page-follow-container1">
            <span className="landing-page-text17">Socials coming soon</span>
